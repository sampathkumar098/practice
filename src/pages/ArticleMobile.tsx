...
const ArticleMobile: FunctionComponent = () => {
  return (
    <div className={styles.articleMobile}>
      ...
      <div className={styles.content1}>
        <div className={styles.images}>
          ...
          <div className={styles.images1}>
            <img
              className={styles.pexelsFauxels31843391Icon1}
              alt=""
              src="/pexelsfauxels3184339-1@2x.png"
            />
            ...
            <div className={styles.card}>
              ...
              <div className={styles.details}>
                ...
                <div className={styles.cta}>
                  <div className={styles.copy8}>Read more</div>
                  <img
          ...
          <div className={styles.offices}>
            <div className={styles.copy}>
              ...
              <div className={styles.level3534Container}>
                ...
                <p className={styles.miTinciduntElit}>Victoria, Australia</p>
            ...
            <div className={styles.copy}>
              ...
              <div className={styles.level3534Container}>
                <p className={styles.miTinciduntElit}>Level 2, 234 Fifth Ave</p>
            ...
            <div className={styles.copy}>
              ...
              <div className={styles.level3534Container}>
                ...
                <p className={styles.miTinciduntElit}>45/3 Mahatma Gandhi Rd</p>
                <p
                  className={styles.miTinciduntElit}
            ...
            <div className={styles.copy11}>
              <div className={styles.heading11}>
                <span className={styles.haveAnIdea}>
                  ...
                  <i className={styles.reading}>idea?</i>
                </span>
              </div>
            </div>
