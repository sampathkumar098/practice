...
const BlogMobile: FunctionComponent = () => {
  return (
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.offices}>
            <div className={styles.copy}>
              ...
              <div className={styles.level3534Container}>
                ...
                <p className={styles.victoriaAustralia}>Victoria, Australia</p>
            ...
            <div className={styles.copy}>
              ...
              <div className={styles.level3534Container}>
                ...
                <p className={styles.victoriaAustralia}>NY, United States</p>
                <p className={styles.victoriaAustralia}>+1 (610) 999-7631</p>
              </div>
              <div className={styles.thu1154}>THU • 11:54 AM</div>
            </div>
            <div className={styles.copy}>
          ...
          <div className={styles.links}>
            <div className={styles.links1}>
              ...
              <div className={styles.button2}>
                <div className={styles.category}>Case Studies</div>
              </div>
            </div>
            <div className={styles.links1}>
              <div className={styles.button2}>
              ...
              <div className={styles.button2}>
                <div className={styles.category}>Careers</div>
              </div>
              <div className={styles.button2}>
                <div className={styles.category}>Privacy Policy</div>
              </div>
            </div>
          </div>
