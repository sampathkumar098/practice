...
import styles from "./Benefits1.module.css";

const Benefits1: FunctionComponent = () => {
  const navigate = useNavigate();

  const onBenefitsContainerClick = useCallback(() => {
    navigate("/benefits");
  }, [navigate]);

  return (
    <div className={styles.benefits} onClick={onBenefitsContainerClick}>
